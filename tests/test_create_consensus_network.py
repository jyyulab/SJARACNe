...
class TestConsensusNetwork(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        cn('inputs/adjmat_dir', 0.05, './test_answers')

    
    def test_consensus_network_3col(self):
        self.assertTrue(filecmp.cmp('./answerkey/consensus_network_3col_.txt', './test_answers/consensus_network_3col_.txt'))
        
    def test_bootstrap_info(self):
        self.assertTrue(filecmp.cmp('./answerkey/bootstrap_info_.txt', './test_answers/bootstrap_info_.txt'))
    ...
    def test_parameter_info(self):  
        ...
        with open('./test_answers/parameter_info_.txt', 'w') as info:
            ...
            info.close()
        self.assertTrue(filecmp.cmp('./answerkey/parameter_info_.txt', './test_answers/parameter_info_.txt'))
