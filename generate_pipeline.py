...
out_4 = open('04_getenhancedconsensusnetwork_' + sys.argv[4] + '.sh', 'w')
thr = '1e-5'
...
for exp in exps:
	...
	if tf != "":
		...
		out_4.write('bsub -q compbio -P gn -M 16000 -o ' + '/'.join(tf_dir) + '/sjaracne2_log_/enhanced_network.log python getenhancedconsensusnetwork.py ' + exp.strip() + ' ' + '/'.join(tf_dir) + '/sjaracne2_out_.final/consensus_network_3col_sjaracne2_out_.txt ' + '/'.join(tf_dir) + '/sjaracne2_out_.final/\n') 
		#out_4.write('bsub -P gn -M 64000 python getenhancedconsensusnetwork.py ' + exp.strip() + ' ' + '/'.join(tf_dir) + '/sjaracne2_out_.final/consensus_network_3col_sjaracne2_out_.txt ' + '/'.join(tf_dir) + '/sjaracne2_out_.final/ ' + tf + '\n') 
	...
	if sig != "":
		...
		out_4.write('bsub -q compbio -P gn -M 16000 -o ' + '/'.join(sig_dir) + '/sjaracne2_log_/enhanced_network.log python getenhancedconsensusnetwork.py ' + exp.strip() + ' ' + '/'.join(sig_dir) + '/sjaracne2_out_.final/consensus_network_3col_sjaracne2_out_.txt ' + '/'.join(sig_dir) + '/sjaracne2_out_.final/\n\n')
		#out_4.write('bsub -P gn -M 64000 python getenhancedconsensusnetwork.py ' + exp.strip() + ' ' + '/'.join(sig_dir) + '/sjaracne2_out_.final/consensus_network_3col_sjaracne2_out_.txt ' + '/'.join(sig_dir) + '/sjaracne2_out_.final/ ' + sig + '\n\n')
